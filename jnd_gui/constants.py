...
INTER_CLIP_GAP_SECONDS = 3
INTER_CLIP_GAP_MS = INTER_CLIP_GAP_SECONDS * 1000
INTER_CLIP_WAIT_PROMPT = f"Clip A finished. Clip B will start in {INTER_CLIP_GAP_SECONDS} seconds."
